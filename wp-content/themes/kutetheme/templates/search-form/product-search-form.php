<?php 
$args = array(
  'show_option_all' => __( 'Tất cả danh mục', 'kutetheme' ),
...
<form class="form-inline woo-search" method="get" action="<?php echo esc_url( home_url( '/' ) ) ?>">
  ...
  <div class="form-group input-serach">
    ...
    <input value="<?php echo esc_attr( get_search_query() );?>" type="text" name="s"  placeholder="<?php esc_attr_e( 'Từ khóa...', 'kutetheme' ); ?>" />
