            ...
            <div id="box-vertical-megamenus" class="vertical-wapper">
                <div data-items="<?php echo esc_attr( $kt_vertical_item_visible );?>" class="box-vertical-megamenus <?php if( $kt_click_open_vertical_menu =="enable") echo esc_attr( 'hiden_content' ); else echo esc_attr( 'show_content' );?>">
                    ...
                    <div class="vertical-menu-content">
                        ...
                        <div class="all-category"><span data-open_text="<?php _e( 'Tất cả danh mục','kutetheme' );?>" data-close_text="<?php _e( 'Close','kutetheme' );?>" class="open-cate"><?php esc_html_e( 'Tất cả danh mục', 'kutetheme' ) ?></span></div>
                    </div>
                </div>
            </div>
            <?php endif; ?>
...
function kt_themne_color(){
    ...
    body .block-popular-cat .sub-Danh mục>ul>li>a:before,
