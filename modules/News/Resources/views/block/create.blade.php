...
@section('title',trans('news::block_create.title'))
@section('markdowns')
...
@section('content')
    ...
    <section class="content-header">
        <h1>
            {{trans('news::block_create.create')}}
        </h1>
        <ol class="breadcrumb">
            <li><a href="{{route('admin_home')}}"><i class="fa fa-dashboard"></i> {{trans('news::block_create.homepage')}}</a></li>
            <li><a href="{{route('news.news_block.index')}}">{{trans('news::block_create.list')}}</a></li>
        </ol>
    </section>
    ...
    <section class="content">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">{{trans('news::block_create.create')}}</h3>
            ...
            <div class="box-body" >
                <div class ="row">
                    <div class="col-md-offset-1 col-md-9">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form class="form-horizontal" method="post" action="{{route('news.news_block.store')}}" enctype="multipart/form-data">
                            {{csrf_field()}}
                            <div class="box-body">
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-md-3 control-label">{{trans('news::block_create.name_block')}} </label>
                                ...
                                <div class="form-group">
                                    <label for="inputPassword3" class="col-sm-3 control-label">{{trans('news::block_create.key_word')}}</label>

                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="inputPassword3" placeholder="...." name="key" value="{{old('key')}}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <a href="/block/filemanager/dialog.php?type=1&lang=en_EN'" data-fancybox data-caption="Upload file manager" class="btn btn-default iframe-btn" type="button">Upload file</a>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1 " class="col-md-3 control-label">{{trans('news::block_create.content')}} (*)</label>
                                    <div class="col-md-9">
                                        <div id="wmd-button-bar"></div>
                                        <textarea class="wmd-input" name="data" id="wmd-input">{{ old('data') }}</textarea>
