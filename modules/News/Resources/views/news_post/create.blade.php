                    ...
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="summary" class="form-control" placeholder="{{trans('news::post_create.placeholder_summary')}}">{{ old('summary') }}</textarea>
                            </div>
                            <div class="form-group">
                                ...
                                <div id="typeContentOther" class="col-md-12" style="display: none;">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="post_type" class="form-control" onchange="return post.changeType(this);">
                                    <option value="">{{trans('news::post_create.please_choose_type')}}</option>
