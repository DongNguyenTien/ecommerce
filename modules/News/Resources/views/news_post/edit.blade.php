                    ...
                    @include('news::includes.message')
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1">{{trans('news::post_edit.cate')}} (*)   <i class="glyphicon glyphicon-info-sign" data-toggle="tooltip" title="You just only choose level 3 category!"></i></label>
                                    <div class="list-categories" style="height: 250px; overflow-y: scroll">
                                        {{menuEditInPost($old_cate_id,$categories,$listCatePermission,$listCategoryCreated)}}
                                    </div>
                                    <br>
                                ...
                                <div class="form-group hidden">
                                    <label for="exampleInputEmail1">{{trans('news::post_edit.tag')}}</label><br>
