...
class NewsController extends ApiController
{
    ...
    public function listPosts(Request $request)
    {
        try {
            ...
            $result = array();
            $query = NewsPost::select(DB::raw('id, title, slug, thumbnail, images, summary, post_type, post_view, data, media, created_id, published_at, created_at, (SELECT count(*) as comment_num FROM news_comments WHERE news_comments.post_id = news_posts.id LIMIT 1) as comment_num'));
